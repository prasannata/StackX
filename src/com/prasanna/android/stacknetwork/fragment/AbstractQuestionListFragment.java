...
public abstract class AbstractQuestionListFragment extends ItemListFragment<Question> implements
        ListItemView<Question>
{
    ...
    public boolean onContextItemSelected(MenuItem item)
    {
        ...
        return onContextItemSelectedListener.onContextItemSelected(item,
    ...
    {
        LinearLayout layout = QuestionRowLayoutBuilder.getInstance().build(
                getActivity().getLayoutInflater(), getActivity(), false, item);
    ...
    public void onCreateContextMenu(ContextMenu menu, View v, ContextMenuInfo menuInfo)
    {
        ...
        menuItem.setTitle(Html.fromHtml(itemListAdapter.getItem(position).owner.displayName)
                + "'s profile");
        ...
        if (itemListAdapter.getItem(position).tags != null)
        {
            ...
            {
                subMenu.add(R.id.qContextTagsMenuGroup, Menu.NONE, idx,
                        itemListAdapter.getItem(position).tags[idx]);
            }
        }
    }
