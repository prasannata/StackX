...
public class UserService
{
    ...
    public void getQuestionsByUser(long userId)
    {
	...
	// question.setRelativeLink(restEndPoint + "/"
	// + jsonObject.getLong(JsonFields.Question.QUESTION_ID));
	...
	question.setCreateDate(jsonObject.getLong(JsonFields.Question.CREATION_DATE));
