...
public class UserService extends AbstractBaseService
{
    ...
    public LinkedHashMap<String, Site> getAllSitesInNetwork(String accessToken)
    {
    ...
    public ArrayList<Question> getAllQuestions(String accessToken, int page)
    {
    ...
    public HashMap<String, Account> getAccounts(String accessToken, int page)
    {
        if (accessToken != null)
        {
