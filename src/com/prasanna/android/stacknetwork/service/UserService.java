...
public class UserService extends AbstractBaseService
{
    ...
    public ArrayList<Account> getAccounts(String accessToken, int page)
    {
    ...
    public ArrayList<Account> getAccounts(long userId, int page)
    {
    ...
    private ArrayList<Account> getAccounts(String restEndPoint, Map<String, String> queryParams)
    {
