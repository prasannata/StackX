...
public class UserServiceHelper extends AbstractBaseServiceHelper
{
    ...
    public StackXPage<User> getMe()
    {
        ...
        queryParams.put(StackUri.QueryParams.FILTER,
                StackUri.QueryParamDefaultValues.USER_DETAIL_FILTER);
    ...
    public ArrayList<InboxItem> getInbox(int page)
    {
        ...
        queryParams.put(StackUri.QueryParams.PAGE_SIZE,
                String.valueOf(StackUri.QueryParamDefaultValues.PAGE_SIZE));
        queryParams.put(StackUri.QueryParams.FILTER,
                StackUri.QueryParamDefaultValues.USER_INBOX_FILTER);
        ...
        if (jsonOfInboxItems != null)
        {
            ...
            if (itemsArray != null)
            {
                ...
                for (int i = 0; i < itemsArray.length(); i++)
                {
                    try
                    {
                        JSONObjectWrapper itemJsonObject = JSONObjectWrapper.wrap(itemsArray
                                .getJSONObject(i));
                        if (itemJsonObject != null)
                        {
                            InboxItem inboxItem = new InboxItem();
                            inboxItem.questionId = itemJsonObject
                                    .getLong(JsonFields.InboxItem.QUESTION_ID);
                            inboxItem.answerId = itemJsonObject
                                    .getLong(JsonFields.InboxItem.ANSWER_ID);
                            inboxItem.commentId = itemJsonObject
                                    .getLong(JsonFields.InboxItem.COMMENT_ID);
                            ...
                            inboxItem.creationDate = itemJsonObject
                                    .getLong(JsonFields.InboxItem.CREATION_DATE);
                            inboxItem.body = itemJsonObject.getString(JsonFields.InboxItem.BODY);
                            inboxItem.unread = itemJsonObject
                                    .getBoolean(JsonFields.InboxItem.IS_UNREAD);
    ...
    public HashMap<String, Account> getAccounts(int page)
    {
        ...
        Map<String, String> queryParams = AppUtils.getDefaultQueryParams();
        queryParams.put(StackUri.QueryParams.FILTER,
                StackUri.QueryParamDefaultValues.NETWORK_USER_TYPE_FILTER);
        queryParams.put(StackUri.QueryParams.PAGE, String.valueOf(page));
        queryParams.put(StackUri.QueryParams.PAGE_SIZE,
                String.valueOf(StackUri.QueryParamDefaultValues.PAGE_SIZE));
    ...
    private HashMap<String, Account> getAccounts(String restEndPoint,
        ...
        if (accountsJsonObject != null)
        {
            ...
            if (jsonArray != null)
            {
                ...
                for (int i = 0; i < jsonArray.length(); i++)
                {
                    try
                    {
                        JSONObjectWrapper accountJsonObject = JSONObjectWrapper.wrap(jsonArray
                                .getJSONObject(i));
                        ...
                        account.siteName = accountJsonObject
                                .getString(JsonFields.Account.SITE_NAME);
                        account.siteUrl = accountJsonObject.getString(JsonFields.Account.SITE_URL);
                        account.userType = UserType.toEnum(accountJsonObject
                                .getString(JsonFields.Account.USER_TYPE));
        ...
        if (jsonObjectWrapper != null)
        {
            ...
            if (jsonArray != null && jsonArray.length() > 0)
            {
                ...
                for (int i = 0; i < jsonArray.length(); i++)
                {
                    try
                    {
                        JSONObjectWrapper tagJson = JSONObjectWrapper.wrap(jsonArray
                                .getJSONObject(i));
