...
public class UserHomeActivity extends AbstractUserActionBarActivity
{
	...
	progressDialog = ProgressDialog
	        .show(UserHomeActivity.this, "", getString(R.string.loading));
	...
	IntentFilter filter = new IntentFilter(
	        IntentActionEnum.QuestionIntentAction.ALL_QUESTIONS.name());
	...
	{
	    LinearLayout topLayout = LayoutBuilder.getInstance().buildQuestionSnippet(this,
		    question);
	    questionsLinearLayout.addView(topLayout, new LinearLayout.LayoutParams(
	...
	ArrayList<Question> questions = (ArrayList<Question>) intent
	        .getSerializableExtra(IntentActionEnum.QuestionIntentAction.ALL_QUESTIONS
	                .getExtra());
