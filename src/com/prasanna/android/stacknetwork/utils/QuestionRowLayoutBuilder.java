...
public class QuestionRowLayoutBuilder
{
    ...
    public LinearLayout build(final LayoutInflater layoutInflater,
            ...
            final Question question)
    {
        ...
        questionRowLayout.setOnClickListener(new View.OnClickListener()
        {
            ...
            {
                Intent displayQuestionIntent = new Intent(view.getContext(), QuestionActivity.class);
    ...
    private void createQuestionSnippetView(final LinearLayout parentLayout,
            final Context context,
            final boolean cached,
            final Question question)
    {
