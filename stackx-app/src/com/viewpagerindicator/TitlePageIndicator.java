...
public class TitlePageIndicator extends View implements PageIndicator {
  /**
   * Percentage indicating what percentage of the screen width away from center
   * should the underline be fully faded. A value of 0.25 means that halfway
  ...
  /**
   * Percentage indicating what percentage of the screen width away from center
   * should the selected text bold turn off. A value of 0.05 means that 10%
